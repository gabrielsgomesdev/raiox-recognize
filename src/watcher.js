...
chokidar_1.default.watch(WATCH_DIR, { ignoreInitial: true, depth: 0 }).on("add", function (filePath) { return __awaiter(void 0, void 0, void 0, function () {
    var ext, fileName, _a, dataUrl, mimeType, hash, bytes, text, payload, headers, resp, dest, err_1;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 3:
                ...
                return [4 /*yield*/, axios_1.default.post(N8N_URL, payload, { headers: headers, timeout: 30000 })];
            case 4:
                resp = _c.sent();
