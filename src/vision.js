...
function describeImage(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var client, model, completion, msg;
        var _c, _d, _e, _f;
        var dataUrl = _b.dataUrl, _g = _b.prompt, prompt = _g === void 0 ? "Descreva objetivamente o que há na imagem, em uma frase clara e útil." : _g;
